...
package body PKG_debug is
   ...
   -- en pantalla
   --------------------------------------------------------------------
   -- No tenemos que escribir la crear fichero porque ya lo llama esta biblioteca en en begin del paquete.
   -- El fichero se llama debug.txt porque está inicializado en la parte privada del spec.
